export default function InputText({label, placeholder, iconPath}) {
    return (
        iconPath ?
        <div className="relative z-0 group">
            ...
            <input type="text" name="floating_email" id="floating_email" className="block w-full py-2.5 pr-2 pl-10 text-sm text-gray-900 bg-transparent border border-black appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-black focus:border-black placeholder-transparent focus:placeholder-gray-500 peer" placeholder={placeholder} required />
        ...
        <input type="text" name="floating_email" id="floating_email" className="block inner-shadow1 w-full py-2.5 px-2 text-sm text-gray-900 bg-transparent border border-black appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-black focus:border-black peer" placeholder={placeholder} required />
