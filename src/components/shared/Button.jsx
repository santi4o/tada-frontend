export default function Button({ buttonText, handleClick }) {
  return (
      ...
      >
        ...
        <span className="absolute rounded-md inset-0 w-full h-full bg-white dark:bg-black border-2 border-black dark:border-white group-focus:bg-black group-focus:dark:bg-white group-hover:bg-black group-hover:dark:bg-white transition duration-100 ease-in"></span>
        <span className="relative text-black dark:text-white group-hover:text-white group-focus:text-white group-hover:dark:text-black group-focus:dark:text-black">
