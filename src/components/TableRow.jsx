    ...
    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
      ...
      <td className="px-4 py-4 flex justify-center">
        <svg
          ...
          viewBox="0 0 20 20"
          className="w-5 h-5 fill-gray-700 cursor-pointer hover:fill-black mr-3"
        >
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          className="w-5 h-5 fill-gray-700 cursor-pointer hover:fill-black"
        >
          <path
            fillRule="evenodd"
  ...
  function genCheckBox(value) {
    return (
      <input
        ...
        value=""
        checked={value}
        onChange={() => console.log("not implemented :c")}
